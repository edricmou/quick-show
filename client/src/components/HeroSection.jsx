...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen w-full gap-4 px-6 md:px-16 lg:px-36'>
      <img
      ...
      <button
        ...
        className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull rounded-full transition font-medium cursor-pointer'
      >
        Explore Movies
